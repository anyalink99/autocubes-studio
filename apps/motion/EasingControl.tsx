...
const labels:Record<EasingName,string>={linear:'Linear',easeIn:'Accelerate',easeOut:'Decelerate',easeInOut:'Smooth',spring:'Spring'};
...
export const EasingControl=({value,onChange}:{value:EasingName;onChange:(value:EasingName)=>void})=><section className="easing-control">
  <div className="easing-head"><span>Motion curve</span><strong>{labels[value]}</strong></div>
